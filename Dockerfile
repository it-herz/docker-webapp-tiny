...
RUN cd /tmp && \
    wget http://ftp.ru.debian.org/debian/pool/main/f/firebird3.0/firebird-dev_3.0.0.32483.ds4-5_all.deb && \
    wget http://ftp.ru.debian.org/debian/pool/main/f/firebird3.0/libfbclient2_3.0.0.32483.ds4-5_amd64.deb && \
    wget http://ftp.ru.debian.org/debian/pool/main/f/firebird3.0/firebird3.0-common_3.0.0.32483.ds4-5_all.deb && \
    wget http://ftp.ru.debian.org/debian/pool/main/f/firebird3.0/firebird3.0-common-doc_3.0.0.32483.ds4-5_all.deb && \
    ...
    wget http://ftp.ru.debian.org/debian/pool/main/f/firebird3.0/libib-util_3.0.0.32483.ds4-5_amd64.deb && \
    dpkg -i *.deb
